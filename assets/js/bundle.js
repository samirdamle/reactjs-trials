...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____Classc=React.Component;for(var ____Classc____Key in ____Classc){if(____Classc.hasOwnProperty(____Classc____Key)){Channel[____Classc____Key]=____Classc[____Classc____Key];}}var ____SuperProtoOf____Classc=____Classc===null?null:____Classc.prototype;Channel.prototype=Object.create(____SuperProtoOf____Classc);Channel.prototype.constructor=Channel;Channel.__superConstructor__=____Classc;function Channel(){if(____Classc!==null){____Classc.apply(this,arguments);}}

	    Object.defineProperty(Channel.prototype,"onClick",{writable:true,configurable:true,value:function() {
	        console.log('I was clicked', this.props.name);
	    }});

	    Object.defineProperty(Channel.prototype,"render",{writable:true,configurable:true,value:function() {
	        return React.createElement("li", {onClick: this.onClick.bind(this)}, this.props.name)
	    }});


	var ____Classd=React.Component;for(var ____Classd____Key in ____Classd){if(____Classd.hasOwnProperty(____Classd____Key)){ChannelList[____Classd____Key]=____Classd[____Classd____Key];}}var ____SuperProtoOf____Classd=____Classd===null?null:____Classd.prototype;ChannelList.prototype=Object.create(____SuperProtoOf____Classd);ChannelList.prototype.constructor=ChannelList;ChannelList.__superConstructor__=____Classd;function ChannelList(){if(____Classd!==null){____Classd.apply(this,arguments);}}
	    Object.defineProperty(ChannelList.prototype,"render",{writable:true,configurable:true,value:function() {
	        return  React.createElement("ul", null, 
	                    this.props.channels.map(function(channel, index)  {
	                        return (
	                            React.createElement(Channel, {key: index, name: channel.name})
	                        )
	                    })
	                )
	    }});
	...
	var ____Classe=React.Component;for(var ____Classe____Key in ____Classe){if(____Classe.hasOwnProperty(____Classe____Key)){ChannelForm[____Classe____Key]=____Classe[____Classe____Key];}}var ____SuperProtoOf____Classe=____Classe===null?null:____Classe.prototype;ChannelForm.prototype=Object.create(____SuperProtoOf____Classe);ChannelForm.prototype.constructor=ChannelForm;ChannelForm.__superConstructor__=____Classe;
	    ...
	    Object.defineProperty(ChannelForm.prototype,"onChange",{writable:true,configurable:true,value:function(e){
	        this.setState({
	            channelName: e.target.value
	        });
	    }});

	    Object.defineProperty(ChannelForm.prototype,"onSubmit",{writable:true,configurable:true,value:function(e){
	        let $__0=  this.state,channelName=$__0.channelName;
	        this.setState({
	            channelName: ''
	        });
	    ...
	    Object.defineProperty(ChannelForm.prototype,"render",{writable:true,configurable:true,value:function() {
	        return  React.createElement("form", {onSubmit: this.onSubmit.bind(this)}, 
	                    React.createElement("input", {type: "text", onChange: this.onChange.bind(this), value: this.state.channelName})
	                )
	    }});


	var ____Classf=React.Component;for(var ____Classf____Key in ____Classf){if(____Classf.hasOwnProperty(____Classf____Key)){ChannelSection[____Classf____Key]=____Classf[____Classf____Key];}}var ____SuperProtoOf____Classf=____Classf===null?null:____Classf.prototype;ChannelSection.prototype=Object.create(____SuperProtoOf____Classf);ChannelSection.prototype.constructor=ChannelSection;ChannelSection.__superConstructor__=____Classf;
	    ...
	    Object.defineProperty(ChannelSection.prototype,"addChannel",{writable:true,configurable:true,value:function(name){
	        let $__0=  this.state,channels=$__0.channels;
	    ...
	    Object.defineProperty(ChannelSection.prototype,"render",{writable:true,configurable:true,value:function() {
	        return  React.createElement("div", null, 
	                    React.createElement(ChannelList, {channels: this.state.channels}), 
	                    React.createElement(ChannelForm, {addChannel: this.addChannel.bind(this)})
	                )
	    }});


	ReactDOM.render(React.createElement(ChannelSection, null), document.getElementById('app'));
